      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.adminstrator") }}">
            ...
            <span class="nav-link-text ms-1">Quản lý quản trị viên</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.sport") }}">
            ...
            <span class="nav-link-text ms-1">Quản lý môn thể thao</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.type") }}">
            ...
            <span class="nav-link-text ms-1">Quản lý loại sân</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.paymentmethod") }}">
            ...
            <span class="nav-link-text ms-1">P.thức thanh toán</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.timeframe") }}">
            ...
            <span class="nav-link-text ms-1">Quản lý khung giờ</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{ route("admin.field") }}">
            ...
            <span class="nav-link-text ms-1">Quản lý sân</span>
          </a>
        </li>
        <li class="nav-item mt-2">
          <div class="d-flex align-items-center nav-link">
            ...
            <span class="font-weight-normal text-md ms-2">Quản lý lịch đặt</span>
          </div>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="{{ route('admin.bookings.create') }}">
            <span class="nav-link-text ms-1">Tạo lịch đặt</span>
          </a>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="{{ route('admin.booking') }}">
            <span class="nav-link-text ms-1">Lịch sử đặt sân</span>
          </a>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="{{ route('admin.bookings.today') }}">
            <span class="nav-link-text ms-1">Lịch sân hôm nay</span>
          </a>
        </li>
      </ul>
    </div>

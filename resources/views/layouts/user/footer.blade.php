<!-- Footer Start -->
    ...
    <script src="{{ asset('theme_user/llib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{ asset('theme_user/llib/counterup/counterup.min.js')}}"></script>
    <script src="{{ asset('theme_user/llib/owlcarousel/owl.carousel.min.js')}}"></script>
